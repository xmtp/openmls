...
impl PublicGroup {
    ...
    pub(crate) fn validate_app_data_update_proposals_and_group_context(
        ...
        // AppDataUpdate machinery (and any application-level validation layered on top of it).
        //
    ...
    /// Returns a [`LeafNodeValidationError`] if an [`crate::extensions::ExtensionType`]
    /// in `extensions` is not supported by a leaf in this tree.
